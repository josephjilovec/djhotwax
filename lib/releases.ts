...
export const releases: Release[] = [
 ...
 {id:"nuits",title:"Nuits Feutrées",category:"French jazz",year:"2026",url:"https://www.youtube.com/watch?v=pXP0UFn44Bs",cover:"/covers/nuits.svg",world:"Velvet Rooms",description:"Late-night French jazz shaped by velvet rooms, rain-lit streets, and the hour when the city lowers its voice."},
...
export const featuredRelease = releases.find((release) => release.id === "nuits")!;
